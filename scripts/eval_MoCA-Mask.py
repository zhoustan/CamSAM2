...
def eval_cls_with_click(cls, output_mode, test_data_folder, predictor, output_path):
    video_dir = os.path.join(test_data_folder, cls, 'Imgs')
    gt_dir = os.path.join(test_data_folder, cls, 'GT')
...
def eval_cls_with_bbox(cls, output_mode, test_data_folder, predictor, output_path):
    video_dir = os.path.join(test_data_folder, cls, 'Imgs')
    gt_dir = os.path.join(test_data_folder, cls, 'GT')
...
def eval_cls_with_mask(cls, output_mode, test_data_folder, predictor, output_path):
    video_dir = os.path.join(test_data_folder, cls, 'Imgs')
    gt_dir = os.path.join(test_data_folder, cls, 'GT')
...
def evaluate_class(cls, predictor, output_mode, prompt_type, test_data_folder, output_path):
    if prompt_type == 'mask':
        return eval_cls_with_mask(cls, output_mode, test_data_folder, predictor, output_path)
    elif prompt_type == 'box':
        return eval_cls_with_bbox(cls, output_mode, test_data_folder, predictor, output_path)
    else:
        return eval_cls_with_click(cls, output_mode, test_data_folder, predictor, output_path)
...
def main():
    ...
    for prompt_type in prompt_types:
        result_path = os.path.join(args.output_path, f"MoCA-Mask_{prompt_type}.json")
        results = {}
        for cls in classes:
            metric = evaluate_class(cls, predictor, args.output_mode, prompt_type, args.data_path, args.output_path)
